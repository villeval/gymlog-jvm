...
object InvokeActions {
    ...
    fun invokeGet(mvc: MockMvc, url: String, params: Map<String, Any> = emptyMap(), token: String): ResultActions {
    ...
    @Throws(Exception::class)
    fun invokePost(mvc: MockMvc, url: String, params: Map<String, Any> = emptyMap(), pathVariables: ArrayList<Any>, body: String, token: String): ResultActions {
        return if(params.isNotEmpty()) {
            val multiValueMap = convertParamsToMultiValueMap(params)
    ...
    @Throws(Exception::class)
    fun invokeDelete(mvc: MockMvc, url: String, params: Map<String, Any> = emptyMap(), pathVariables: ArrayList<Any>, token: String): ResultActions {
        return if(params.isNotEmpty()) {
            val multiValueMap = convertParamsToMultiValueMap(params)
            when (pathVariables.size) {
